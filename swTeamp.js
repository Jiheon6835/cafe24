...
app.get("/culture.html", (req, res) => {
  res.sendFile(__dirname + "/culture.html");
});
...
app.get("/po1.html", (req, res) => {
  res.sendFile(__dirname + "/po1.html");
});

app.get("/po2.html", (req, res) => {
  res.sendFile(__dirname + "/po2.html");
});

app.get("/po3.html", (req, res) => {
  res.sendFile(__dirname + "/po3.html");
});

app.get("/po4.html", (req, res) => {
  res.sendFile(__dirname + "/po4.html");
});

app.get("/po5.html", (req, res) => {
  res.sendFile(__dirname + "/po5.html");
});

app.get("/po6.html", (req, res) => {
  res.sendFile(__dirname + "/po6.html");
});

app.get("/po7.html", (req, res) => {
  res.sendFile(__dirname + "/po7.html");
});

app.get("/ul1.html", (req, res) => {
  res.sendFile(__dirname + "/po1.html");
});

app.get("/ul2.html", (req, res) => {
  res.sendFile(__dirname + "/po2.html");
});
app.get("/ul3.html", (req, res) => {
  res.sendFile(__dirname + "/po3.html");
});
app.get("/ul4.html", (req, res) => {
  res.sendFile(__dirname + "/po4.html");
});
app.get("/ul5.html", (req, res) => {
  res.sendFile(__dirname + "/po5.html");
});
app.get("/ul6.html", (req, res) => {
  res.sendFile(__dirname + "/po6.html");
});
app.get("/ul7.html", (req, res) => {
  res.sendFile(__dirname + "/po7.html");
});
app.get("/ul8.html", (req, res) => {
  res.sendFile(__dirname + "/po8.html");
});

app.get("/young1.html", (req, res) => {
  res.sendFile(__dirname + "/young1.html");
});
app.get("/young2.html", (req, res) => {
  res.sendFile(__dirname + "/young2.html");
});

app.get("/young3.html", (req, res) => {
  res.sendFile(__dirname + "/young3.html");
});

app.get("/young4.html", (req, res) => {
  res.sendFile(__dirname + "/young4.html");
});

app.get("/young5.html", (req, res) => {
  res.sendFile(__dirname + "/young5.html");
});

app.get("/young6.html", (req, res) => {
  res.sendFile(__dirname + "/young6.html");
});

app.get("/young7.html", (req, res) => {
  res.sendFile(__dirname + "/young7.html");
});

app.get("/young8.html", (req, res) => {
  res.sendFile(__dirname + "/young8.html");
});

app.get("/yung.html", (req, res) => {
  res.sendFile(__dirname + "/yung.html");
});
app.get("/yung2.html", (req, res) => {
  res.sendFile(__dirname + "/yung2.html");
});
app.get("/yung3.html", (req, res) => {
  res.sendFile(__dirname + "/yung3.html");
});
app.get("/yung4.html", (req, res) => {
  res.sendFile(__dirname + "/yung4.html");
});
app.get("/yung5.html", (req, res) => {
  res.sendFile(__dirname + "/yung5.html");
});
app.get("/yung6.html", (req, res) => {
  res.sendFile(__dirname + "/yung6.html");
});
app.get("/yung7.html", (req, res) => {
  res.sendFile(__dirname + "/yung7.html");
});
app.get("/yung8.html", (req, res) => {
  res.sendFile(__dirname + "/yung8.html");
});
app.get("/kyung.html", (req, res) => {
  res.sendFile(__dirname + "/kyung.html");
});
app.get("/kyung2.html", (req, res) => {
  res.sendFile(__dirname + "/kyung2.html");
});

app.get("/kyung3.html", (req, res) => {
  res.sendFile(__dirname + "/kyung3.html");
});

app.get("/kyung4.html", (req, res) => {
  res.sendFile(__dirname + "/kyung4.html");
});

app.get("/kyung5.html", (req, res) => {
  res.sendFile(__dirname + "/kyung5.html");
});

app.get("/kyung6.html", (req, res) => {
  res.sendFile(__dirname + "/kyung6.html");
});

app.get("/kyung7.html", (req, res) => {
  res.sendFile(__dirname + "/kyung7.html");
});

app.get("/kyung8.html", (req, res) => {
  res.sendFile(__dirname + "/kyung8.html");
});
